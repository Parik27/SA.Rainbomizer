...
{
    if (std::find(weapon_slots[0].begin(), weapon_slots[0].end(), weapon) != weapon_slots[0].end()
        || std::find (weapon_slots[1].begin (), weapon_slots[1].end (), weapon) != weapon_slots[1].end ()
        || std::find (weapon_slots[10].begin (), weapon_slots[10].end (), weapon) != weapon_slots[10].end ())
    {
        return Melee;
    }
    else if (std::find(weapon_slots[2].begin(), weapon_slots[2].end(), weapon) != weapon_slots[2].end())
    {
        return Pistol;
    }
    else if (std::find (weapon_slots[3].begin (), weapon_slots[3].end (), weapon) != weapon_slots[3].end ())
    {
        return Shotgun;
    }
    else if (std::find (weapon_slots[4].begin (), weapon_slots[4].end (), weapon) != weapon_slots[4].end ())
    {
        return SMG;
    }
    else if (std::find (weapon_slots[5].begin (), weapon_slots[5].end (), weapon) != weapon_slots[5].end ())
    {
        return Assault;
    }
    else if (std::find (weapon_slots[6].begin (), weapon_slots[6].end (), weapon) != weapon_slots[6].end ())
    {
        return Rifle;
    }
    else if (std::find (weapon_slots[7].begin (), weapon_slots[7].end (), weapon) != weapon_slots[7].end ())
    {
        return Heavy;
    }
    else if (std::find (weapon_slots[8].begin (), weapon_slots[8].end (), weapon) != weapon_slots[8].end ())
    {
        return Projectile;
    }
    else if (std::find (weapon_slots[9].begin (), weapon_slots[9].end (), weapon) != weapon_slots[9].end ())
    {
        return Spray;
    }
    else
...
WeaponPattern::DoesWeaponMatchPattern (int weaponID)
{
    ...
    if (!GetPickup () && GetPedType() != 0 && (weaponID == 14 || weaponID == 39))
        return false;
    ...
    if (mFlags.Flame
        && weaponID != 16 && weaponID != 18 && weaponID != 35 && weaponID != 36
...
/*******************************************************/
bool
WeaponPattern::MatchWeapon (int weaponID, int ped,
                            bool pickup)
{
